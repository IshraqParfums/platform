...
/**
 * Marks the end of the product content, so the sticky buy bar can retire
 * before the footer rather than floating over it.
 *
 * The bar is `position: fixed`, so it sits above whatever scrolls under it —
 ...
 *
 * It also happens to be the honest rule. The bar exists for "you're mid-page
