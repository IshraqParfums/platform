 ...
 * list rather than hardcoded slugs. Mobile uses accordion nav; desktop keeps
    ...
    <footer className="grain relative overflow-hidden bg-deep-deeper text-cream/70">
      ...
      <Container size="wide">
        ...
        <div className="mt-8 md:hidden">
          <FooterMobileNav columns={mobileColumns} />
        </div>
        ...
        <div className="flex flex-col gap-5 border-t border-cream/10 py-7 md:border-cream/10 sm:flex-row sm:items-center sm:justify-between">
