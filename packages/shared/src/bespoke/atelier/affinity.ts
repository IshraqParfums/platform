...
import type {
  AtelierConstituent as Constituent,
  AtelierFacetLexicon as FacetLexicon,
  AtelierMaterialComposition as MaterialComposition,
  AtelierTechniqueNote as TechniqueNote,
} from "../atelier-contracts.js";

export type { Constituent, FacetLexicon, MaterialComposition, TechniqueNote };
